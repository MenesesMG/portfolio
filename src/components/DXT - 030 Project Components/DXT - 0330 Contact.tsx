...
const DCT0330Contact: React.FC = () => {
    ...
    return (
        <section className="container block mx-auto pt-40 px-4 sm:px-6 flex flex-col items-center">
            <div className="w-full bg-project-color md:rounded-[40px] max-h-[450px] p-5 md:p-10 flex flex-col md:flex-row items-center text-white relative overflow-hidden h-[380px] md:h-auto">
                ...
                <div className="right-side hidden md:flex md:w-1/2 h-full justify-center items-center">
                    <img 
                        src={getImagePath('/OFWakoiPhone.png')} 
                        alt="Project Mockup" 
